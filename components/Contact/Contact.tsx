...
const SOCIAL_LINKS = [
  {
    label: "Email",
    href: "mailto:balabhargav960@gmail.com",
    value: "balabhargav960@gmail.com",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/p-bala-bhargav-71394a268/",
    value: "P Bala Bhargav",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/BalaBhargav329",
    value: "BalaBhargav329",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <section ref={sectionRef} className={styles.section} id="contact">
      <div className={styles.container}>
        ...
        <div ref={cardsRef} className={styles.socialGrid}>
